...
declare const cesiumReadonlyProps: readonly ["url", "showOutline", "cullWithChildrenBounds", "debugHeatmapTilePropertyName", "enableDebugWireframe", "modelUpAxis", "modelForwardAxis", "projectTo2D", "enableShowOutline"];
...
declare const cesiumReadonlyProps_11: readonly ["allowPicking", "asynchronous", "basePath", "credit", "enableDebugWireframe", "gltf", "heightReference", "incrementallyLoadTextures", "scene", "url", "releaseGltfJson", "cull", "opaquePass", "upAxis", "forwardAxis", "content", "scene", "enableShowOutline", "projectTo2D", "classificationType"];
...
declare type Target_10 = Merge<Model_2, Parameters<typeof Model_2["fromGltf"]>[0]>;
...
export declare const useCesiumComponent: <Element_1, Props extends RootComponentInternalProps, State = any>({ name, create, destroy, provide, update, cesiumReadonlyProps, cesiumEventProps, otherProps, setCesiumPropsAfterCreate, useCommonEvent, useRootEvent, }: Options<Element_1, Props, State>, props: Props, ref: any) => [Partial<Context> | undefined, boolean, RefObject<HTMLDivElement>];
...
declare type ViewerCesiumReadonlyProps = Merge<PickCesiumProps<Target_25, typeof cesiumReadonlyProps_18>, {
...
export declare const withCesium: <P, C>(Component: WithContextType<P, C>) => React_2.ForwardRefExoticComponent<React_2.PropsWithoutRef<P> & React_2.RefAttributes<WithContextType<P, C>>>;
